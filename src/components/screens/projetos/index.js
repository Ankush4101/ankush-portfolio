...
const repositoriosId = {
  ...
  857598927: '/images/picsy1.png',
  856667723: '/images/image_colorization.webp',
  856666858: '/images/Text Detection & Prediction.png',
  857590200: '/images/d_appointment.png',
  857593053: '/images/emotion_analysis.jpg',
};
    ...
    <ContainerProjetos>
      ...
      >
        ...
        >
          <ProjetoPrincipal>
            <li>
              <a href='https://github.com/Ankush4101/ankush-portfolio'>
              <Box
                display="flex"
                flexDirection="column"
              ...
              >
                <img
                  src="https://i.postimg.cc/7P92QnYP/Screenshot-2024-09-12-at-6-12-55-PM.png"
                  alt="A N K U S H"
                />
                <Box
                  display="flex"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <Text tag="p" variant="paragraph3" color="fonts.main">14</Text>
                        </Box>
                        <Box
                          display="flex"
                          alignItems="center"
                        ...
                        >
                          ...
                          <Text tag="p" variant="paragraph3" color="fonts.main">9</Text>
                        </Box>
                      </Box>
                    </Box>
      ...
      >
        <Text
          ...
          variant="paragraph1XS"
          color="fonts.main"
          href="https://github.com/Ankush4101?tab=repositories"
          target="_blank"
          rel="noopener noreferrer"
        >
          See Other Projects
